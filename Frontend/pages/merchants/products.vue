<template>
  <div class="bg-[#f4f3f2] flex h-screen">
    ...
    <div class="flex-1 flex flex-col">
      ...
      <button @click="createProduct" class="items-center ml-[1300px] w-60 px-6 py-3 text-xl text-white font-bold rounded-full bg-gradient-to-br from-purple-400 to-blue-400 hover:from-purple-500 hover:to-blue-500 transition-shadow shadow-lg">
